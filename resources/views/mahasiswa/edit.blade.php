                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control" placeholder="Tambahkan Nama Lengkap" value="{{ is_null
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="tgl_lahir" class="form-control" placeholder="Tambahkan Tanggal Lahir" value="{{ is_null
